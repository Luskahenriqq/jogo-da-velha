...
$(".casa").click(function(){
  ...
  var existemCasasIguais = [verificaSeHaCasasIguais(1,2,3), verificaSeHaCasasIguais(4,5,6),
     verificaSeHaCasasIguais(7,8,9), verificaSeHaCasasIguais(1,4,7), verificaSeHaCasasIguais(2,5,8),
     verificaSeHaCasasIguais(3,6,9), verificaSeHaCasasIguais(1,5,9), verificaSeHaCasasIguais(3,5,7)];
  ...
  function verificaSeHaCasasIguais(numeroPrimeiraCasa, numeroSegundaCasa, numeroTerceiraCasa){
